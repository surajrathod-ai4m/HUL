...
table_name = 'plc_data12'

# Define the CSV file path
csv_file_path = '/home/suraj-rathod/Desktop/HUL/CSVs/plc_data_20240630141513_part12.csv'
...
for index, row in df.iterrows():
    ...
    cursor.execute(insert_query, {
        ...
        'spare11': row['spare11'], 'spare12': row['spare12'], 'spare13': row['spare13'], 'spare14': row['spare14'], 'spare15': row['spare15'], 'cycle_time_ms': row['cycle_time_ms'], 'plc_timestamp': plc_timestamp_str
    })
